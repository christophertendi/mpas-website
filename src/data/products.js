...
export const products = [
  ...
  },
  {
    ...
    description: "The MPAS Mobile Well Test Unit features the proven Accuflow MPFM (Multiphase Flow Meter) technology mounted on heavy-duty truck platforms. Using a 2-phase full-separation method with GLCC (Gas-Liquid Cylindrical Cyclone) technology, these units provide accurate measurement of oil, water, and gas production. The system operates with minimal pressure drop (3-4 psi) and can handle operating pressures up to 1,000 psig and temperatures up to 250°F. With PLC-based control, automated data logging, and integrated operator cabins, MPAS has successfully conducted over 10,000 well tests annually across Indonesia and international operations.",
    features: [
      "Truck-mounted (Isuzu FVZ-34U, 285 PS, 6x4)",
      "2-phase full-separation method using GLCC technology",
      "Dual operating modes: Junior (0-700 BFPD) and Senior (400-5,500 BFPD)",
      "Micro Motion Elite Coriolis meters for high accuracy (±0.1% liquid, ±0.0005 g/cc density)",
      "Auto density calibration feature",
      "PLC-based level control with PID tuning",
      "Schneider PLC M340 with Vijeo XL HMI",
      "Data logging capability (24-hour continuous)",
      "Instant report generation with graphical charting",
      "Self-contained power: 24V DC battery system + 10 kVA genset",
      "Air-conditioned operator cabin (1.8m x 2.4m x 2.3m)",
      "Complete instrumentation: pressure, temperature, level transmitters"
    ],
    benefits: [
    ...
    specs: {
      "Liquid Flow Rates": "50 – 5,500 BFPD",
      "Gas Flow Rates": "0 – 200 Mscfd @ 50 psig",
      "Operating Temperature": "Up to 250°F",
      "Operating Pressure": "50 – 1,000 Psig",
      ...
      "Gas Metering": "Micro Motion F Series 1\" Coriolis",
      "Liquid Metering (Junior)": "Micro Motion Elite CMF100M 1\"",
      "Liquid Metering (Senior)": "Micro Motion Elite CMF300M 3\"",
      "Control System": "Schneider PLC M340 with HMI",
      "Level Control Valve": "Fisher V-Ball 3\"-600#",
      "Power Supply": "24 Vdc Battery System (2 sets, 100 AH)",
      "Genset": "Perkins 10 kVA",
      "Air Compressor": "Viva Air 3.5 SCFM, 1 HP",
      "Operator Cabin": "1.8m x 2.4m x 2.3m (Air-conditioned)",
    ...
    clients: [
      "PT Pertamina Hulu Rokan - SLN (2021-2027)",
      "PT Pertamina Hulu Rokan - SLS (2021-2022)",
      "Chevron Pacific Indonesia - SLN (2011-2021)",
      "Chevron Pacific Indonesia - SLS (2013-2021)",
      "PT Pertamina EP - Zona 7 (2009-2025)",
      "Petro Energy / GPOC - South Sudan (2020-2021)",
      "Nile Delta - South Sudan (2020-2021)"
    ],
    services: [
